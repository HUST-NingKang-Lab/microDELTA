...
c1 = pd.concat([pd.read_csv('nn_result/exp_{}/Search/layer-2.csv'.format(i), index_col=0) for i in range(8)])
...
print(plot)
plot.save('Figure_nn.pdf', dpi=120, width=6.4*1.2, height=4.8)